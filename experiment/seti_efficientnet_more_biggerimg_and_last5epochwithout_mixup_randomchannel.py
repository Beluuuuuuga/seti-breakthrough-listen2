...
from seti_dataset import TrainDataset, TestDataset, TrainDatasetRandom
    ...
    if data == "train":
        return A.Compose(
            [
                ...
                A.Resize(CFG.h_size, CFG.w_size, cv2.INTER_LANCZOS4),
...
def train_fn(train_loader, model, criterion, optimizer, epoch, scheduler, device):
    ...
    # mixup off
    if (CFG.epochs - epoch) < 5:
        CFG.mixup_flag = False
...
def train_loop(folds, fold):
    ...
    train_dataset = TrainDatasetRandom(
